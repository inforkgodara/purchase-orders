        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
                <div class="box box-primary">
                    ...
                    <form @submit.prevent="update('city-form')" action="/" method="post"
                        ...
                        <div class="box-body">
                            ...
                            <div :class="{'form-group': true, 'has-error': errors.has('city-form.country') }">
                                ...
                                <select name="country" @change="changeProvince($event)" class="form-control" v-validate="'required'"
    ...
    export default {
        ...
        mounted() {
            ...
            axios.get(this.url + app.$route.params.id + '/edit')
                .then(function (resp) {
                    app.element = resp.data.city;
                    app.provinces = resp.data.provinces.provinces;
                    app.countries = resp.data.provinces.countries;
                })
                .catch(function (resp) {
                    app.error();
                })
