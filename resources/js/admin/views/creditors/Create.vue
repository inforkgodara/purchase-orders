                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i class="fa fa-arrow-left cursor-pointer"
                                ...
                                <router-link :to="{ name: 'creditors' }" id="back"></router-link>
                            </i>
                            Add Creditor
                        </h3>
                    </div>
                    <form @submit.prevent="store('creditors-form')" action="/" method="post" data-vv-scope="creditors-form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <div :class="{'form-group': true, 'has-error': errors.has('creditors-form.branch') }">
                                        <label>Branch</label>
                                        ...
                                        <span class="help-block">{{ errors.first('creditors-form.branch') }}</span>
                                    </div>
                                    <div :class="{'form-group': true, 'has-error': errors.has('creditors-form.name') }">
                                        <label for="name">Name </label>
                                        <input type="text" name="name" v-model="element.name"
                                            class="form-control" v-validate="'required|max:100'" id="name"
                                            placeholder="Enter name">
                                        <span class="help-block">{{ errors.first('creditors-form.name') }}</span>
                                    </div>
                                    <div :class="{'form-group': true, 'has-error': errors.has('creditors-form.days') }">
                                        ...
                                        <span class="help-block">{{ errors.first('creditors-form.days') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div :class="{'form-group': true, 'has-error': errors.has('creditors-form.limit') }">
                                        ...
                                        <input type="text" name="limit" v-model="element.credit_limit"
                                            ...
                                            placeholder="Enter credit days">
                                        <span class="help-block">{{ errors.first('creditors-form.limit') }}</span>
                                    </div>
                                    <div :class="{'form-group': true, 'has-error': errors.has('creditors-form.term') }">
                                        ...
                                        <span class="help-block">{{ errors.first('creditors-form.term') }}</span>
                                    </div>
                                    <div :class="{'form-group': true, 'has-error': errors.has('creditors-form.category') }">
                                        ...
                                        <span class="help-block">{{ errors.first('creditors-form.category') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div :class="{'form-group': true, 'has-error': errors.has('creditors-form-form.building') }">
                                        <label>Building</label>
                                        <input class="form-control" v-model="element.building" name="building"
                                            v-validate="'max:255'" placeholder="Enter building">
                                        <span class="help-block">{{ errors.first('creditors-form-form.building') }}</span>
                                    </div>
                                    <div :class="{'form-group': true, 'has-error': errors.has('creditors-form-form.street') }">
                                        <label>Street</label>
                                        <input class="form-control" v-model="element.street" name="street"
                                            v-validate="'max:255'" placeholder="Enter street">
                                        <span class="help-block">{{ errors.first('creditors-form-form.street') }}</span>
                                    </div>
                                    <div :class="{'form-group': true, 'has-error': errors.has('creditors-form.city') }">
                                        <label>City</label>
                                        ...
                                        <span class="help-block">{{ errors.first('creditors-form.city') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div :class="{'form-group': true, 'has-error': errors.has('creditors-form.contact') }">
                                        ...
                                        <span class="help-block">{{ errors.first('creditors-form.contact') }}</span>
                                    </div>
                                    <div :class="{'form-group': true, 'has-error': errors.has('creditors-form.email') }">
                                        ...
                                        <span class="help-block">{{ errors.first('creditors-form.email') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="box-footer">
                            ...
                            <button class="btn btn-primary btn-flat"
                                ...
                                Cancel
                                <router-link :to="{ name: 'creditors' }" id="cancel"></router-link>
                            </button>
                        </div>
                    </form>
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                dropDownData: [],
                url: '/admin/creditors',
                cityUrl: '/admin/resource-creditors',
                process: false,
                cities: [],
            }
        },
