    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="index2.html" class="logo">
                <span class="logo-mini"><b>Purchase</b> Orders</span>
                <span class="logo-lg"><b>Purchase</b> Orders</span>
            </a>
                            ...
                            <ul class="dropdown-menu">
                                <li class="user-header">
                                    <img src="{{ asset('dist/img/user2-160x160.jpg') }}" class="img-circle"
                                        alt="User Image">
                                    <p>
                                        {{ auth()->user()->name }} - Software Engineer
                                        <small></small>
                                    </p>
                                </li>
                                <li class="user-body">
        ...
        <footer class="main-footer">
            ...
            <strong>Developed <a href="#">By Ramesh Kumar</a>.</strong> All rights
            reserved.
        </footer>
